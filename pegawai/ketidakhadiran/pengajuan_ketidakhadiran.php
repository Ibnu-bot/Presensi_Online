...
if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['file'])) {
        ...
        $ekstensi_diizinkan = ["jpeg", "png", "jpg", "pdf"];
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!in_array(strtolower($ambil_ekstensi), $ekstensi_diizinkan)) {
            $pesan_kesalahan[] = "<i class='fa-solid fa-check'></i> Hanya file JPG, JPEG, PNG dan PDF yang diizinkan";
        }
        ...
        if (!empty($pesan_kesalahan)) {
            ...
            $result = mysqli_query($connection, "INSERT INTO ketidakhadiran(id_pegawai, tanggal, keterangan,
            deskripsi, status_pengajuan, file) VALUES 
            ('$id','$tanggal','$keterangan','$deskripsi','$status_pengajuan','$nama_file')");
