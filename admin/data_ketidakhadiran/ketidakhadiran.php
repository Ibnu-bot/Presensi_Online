...
$result = mysqli_query($connection, "SELECT pegawai.nama, ketidakhadiran.* FROM pegawai JOIN ketidakhadiran ON ketidakhadiran.id_pegawai = pegawai.id ORDER BY id DESC");
?>
