...
if (isset($_POST['submit'])) {
    ...
    $ambil_nip =  mysqli_query($connection, "SELECT nip FROM pegawai ORDER BY nip DESC 
    LIMIT 1");
    ...
    if (isset($_FILES['foto'])) {
        ...
        $ekstensi_diizinkan = ["jpeg", "png", "jpg"];
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!empty($pesan_kesalahan)) {
            ...
            jenis_kelamin, alamat, no_handphone, jabatan, lokasi_presensi, foto) VALUES 
            ('$nip','$nama','$jenis_kelamin','$alamat','$no_handphone','$jabatan','$lokasi_presensi',
            '$nama_file')");
