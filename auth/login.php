...
if (isset($_POST["login"])) {
  ...
  $result = mysqli_query($connection, "SELECT * FROM users JOIN pegawai ON users.id_pegawai
  = pegawai.id WHERE username = '$username'");
    ...
    <div class="container container-normal py-4">
      <div class="row align-items-center g-4">
        <div class="col-lg">
          <div class="container-tight">
            <div class="text-center mb-4">
              <a href="." class="navbar-brand navbar-brand-autodark"><img src="<?= base_url('assets/img/lambang.gif') ?>" height="36" alt=""></a>
            </div>
        ...
        <div class="col-lg d-none d-lg-block">
          <img src="<?= base_url('assets/img/logo-dinas.png') ?>" height="300" class="d-block mx-auto" alt="">
          <div class="text-center font-weight-bold">Desa Kasugengan Lor Depok - Cirebon</div>
        </div>
      </div>
    </div>
  </div>
